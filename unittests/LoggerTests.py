...
from logger2 import update_train_log, update_predict_log
...
class LoggerTest(unittest.TestCase):
    ...
    def test_01_train(self):
        ...
        ## update the log
        tag = "unitedkingdom"
        date = "2017-12-11,2017-12-31"
        eval_rmse = "0.05"
        runtime = "00:00:01"
        MODEL_VERSION = 0.1
        MODEL_VERSION_NOTE = "test model"
        
        update_train_log(tag,date,eval_rmse,runtime,MODEL_VERSION, MODEL_VERSION_NOTE,test=True)
    ...
    def test_02_train(self):
        ...
        self.assertEqual(eval_rmse, logged_eval_test)
